...
The following is the documentation of the genailib_rg_sube.py. Its holistic purpose is to connect to openai and
return a response depending on the prompt you have given it.

```bash
❯ python genailib_rg/genailib_rg_sub.py
