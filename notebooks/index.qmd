...
Welcome to the documentation for genailib_rg! We are excited to have you here.
...
rootdir: /Users/reginagarfiasgarciatorres/rgwl_superproject/genailib_rg
...
------------------------------------------------------------------
genailib_rg/__init__.py                     8      4    50%
genailib_rg/test_openai_connection.py      17      4    76%
...
❯ pixi run program
✨ Pixi task (program in default): python3 genailib_rg/genailib_rg_sub.py
Enter the model (default: gpt-3.5-turbo):
Hello! How can I help you today?

❯ pixi run docs
✨ Pixi task (docs in dev): mkdir -p docs; cd notebooks; nbdev_docs; cp -r _docs/* ../docs/; cd ..
Could not find rootdir: /Users/reginagarfiasgarciatorres/rgwl_superproject/genailib_rg/index.ipynb
[1/4] index.qmd
[2/4] console.ipynb
